...
hidden if the `Connect4_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Connect4_DEVELOPER_MODE` to the configure
...
Runs the executable target `Connect4_exe`.
